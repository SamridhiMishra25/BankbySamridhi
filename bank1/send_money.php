...
<body style="background-color:#bdbdbd; padding-top:8%;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:80%; background-color:light; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px light;">
            ...
            <div class="" style=" backdrop-filter: blur(5px); border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    ...
                    <br>
                    <input class="btn mybtn btn-outline-black" type="submit" value="Transfer"><br><br>
