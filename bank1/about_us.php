...
<body style="background-image:url('statics/absss.jpg'); padding-top:8%;>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:white; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:black;">About Us</h1>
            </div>
            <br><br>
            <img src="statics/samridhi.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:black;">This website is created by</p>
            <h1 style="color:black; text-shadow:2px 2px 2px gray;">Samridhi</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Jyoti Nivas College Autonomous, Banglore</b></p>
    </center>
