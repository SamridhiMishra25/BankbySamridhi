...
<body style="background-color:megenta;">
...
<div id="container">
    ...
    <div class="container-large"
        style="color:black; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:megenta;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-family: elephant;size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Bank of<br> Spark
                        </b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/bank1.jpg" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:cremson;"><b>Our Awesome Facilities</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:cremson; color:black; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
